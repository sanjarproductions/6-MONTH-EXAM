...
const Discovery = () => {
    ...
    return !exceptions.includes(location.pathname) ? (
        <div className='slider-wrapper'>
            ...
            <Swiper slidesPerView={9} spaceBetween={120} freeMode={true} modules={[FreeMode, Autoplay]}
                autoplay={{
                    delay: 2500,
                                ...
                                <div className="discrovery_movies-wrapper">
                                    <div className="discrovery_movie__wrapper">
                                        <Link to={`/about/${moviePic.id}`}>
                                            <img className='discrovery_movie' src={`https://image.tmdb.org/t/p/original/${moviePic.backdrop_path}`} alt="" />
                                        </Link>
